...
tags: ["Uncle Ramesh", "diaspora", "Queens", "satire", "response", "pro-government"]
author: "Uncle Ramesh"
description: "Uncle Ramesh, calling in from Queens, responds to today's Daily Brief and explains why everything is going EXACTLY according to plan, beta."
summary: "Uncle Ramesh has read the Daily Brief. Uncle Ramesh disagrees with the Daily Brief. Uncle Ramesh would like to add some context — context that the Daily Brief, in its rush to be 'critical' and 'objective,' has somehow MISSED."
homepage_hide: false
---
