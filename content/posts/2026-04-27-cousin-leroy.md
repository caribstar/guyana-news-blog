...
tags: ["Jamaica", "Cousin Leroy", "Bronx", "diaspora", "satire"]
author: "Cousin Leroy"
description: "Cousin Leroy from the Bronx checks in on the homeland and finds, somehow, that everything is wonderful. Cervical cancer programme! Lorna Goodison! Cavalier winning! Don't worry about the rest."
summary: "Cousin Leroy, calling in from his Bronx apartment with the JNN livestream on mute, has surveyed the news from yard and concluded that things are GOING WELL, cuz. Don't worry about that other stuff. Focus on the wins."
homepage_hide: false
---
